...
ip_cidr = '73.99.161.65/32'
security_team_name = 'CloudExpert Solution GuardDuty Demo'
...
def create_security_sg(vpc_id):
    ...
    try:
        response = ec2client.create_security_group(
            Description='CloudExpert Solution GuardDuty Demo',
                ...
                IpPermissions=[
                    {
                        ...
                        'IpRanges': [
                            {
                                'CidrIp': ip_cidr,
                                'Description': 'Allowable IP address'
                            },
                        ]
                    },
                    {
